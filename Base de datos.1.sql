...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-12-2023 a las 13:22:29
...
ALTER TABLE `inventario`
  ...
  ADD KEY `FKID_devolucion` (`ID_Devolucion`);
...
ALTER TABLE `productos`
  ...
  ADD KEY `FKID_ImagenProducto` (`ID_ImagenProducto`);
...
ALTER TABLE `inventario`
  ...
  ADD CONSTRAINT `devolucion` FOREIGN KEY (`ID_Devolucion`) REFERENCES `devoluciones` (`ID_Devoluciones`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `productos`
  ...
  ADD CONSTRAINT `imagen` FOREIGN KEY (`ID_ImagenProducto`) REFERENCES `galeria` (`ID_ImagenProducto`) ON DELETE CASCADE ON UPDATE CASCADE;
